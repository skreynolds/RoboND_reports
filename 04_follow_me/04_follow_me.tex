...
\captionof{figure}{A mask of the image seen in Figure XXXX highlighting pixels which contain the \textit{hero}}
\end{minipage}
\end{figure}
...
\captionof{figure}{A mask of the image seen in Figure XXXX highlighting pixels which contain people other than the \textit{hero}}
\end{minipage}
\hspace{1cm}
\begin{minipage}{0.45\textwidth}
\centering
\frame{\includegraphics[height=4cm]{cam4}}
\captionof{figure}{A mask of the image seen in Figure XXXX highlighting pixels which contain the background}
\end{minipage}
\end{figure}
