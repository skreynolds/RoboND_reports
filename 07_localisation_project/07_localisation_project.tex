...
The robot was equipped with a differential drive controller, called \texttt{tits}, which allowed ROS to control the robot wheels. Similarly, controllers for the camera and laser range finder were equipped which were called \texttt{urmum} and \texttt{tits milk}, respectively.
...
\texttt{obstacle\_range} & \\
\texttt{raytrace\_range} & \\
\bottomrule
\end{tabular}
\end{minipage}
