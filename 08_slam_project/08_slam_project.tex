...
\hspace{1cm}
\begin{minipage}{0.45\textwidth}
	\captionof{table}{A complete list of robot links, including parent links}
	\begin{tabular}{ll}
		\toprule
...
\begin{table}[h]
	\centering
	\captionof{table}{Some of the important topics and parameters that need to be properly configured to ensure RTAB-Map will function correctly}
		\small
		\begin{tabular}{ll}
			\toprule
...
\begin{figure}[h]
\centering
\frame{\includegraphics[scale=0.23]{benchmark_env}}
...
\begin{figure}[h]
\centering
\frame{\includegraphics[scale=0.23]{alternative_env}}
